        ...
        >
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="font-semibold text-foreground uppercase">Current Plan: {user?.subscription_tier || 'Free'}</h3>
                <p className="text-muted-foreground text-sm">
                  {user?.subscription_tier === 'pro' ? 'Next billing date: February 15, 2025' : 'Unlock full potential with Pro'}
                </p>
              </div>
            </div>
