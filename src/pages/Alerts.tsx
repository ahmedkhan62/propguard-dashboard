      ...
      <div className="space-y-6">
        ...
        >
          ...
          <p className="text-muted-foreground">
            Stay disciplined with real-time trading alerts
          </p>
        </motion.div>
                ...
                <div>
                  ...
                  <div className="h-2 bg-secondary rounded-full overflow-hidden">
                    <motion.div
                      initial={{ width: 0 }}
                      animate={{
                        width: `${(disciplineStatus.tradesToday / disciplineStatus.maxTrades) * 100}%`,
                      }}
                      className={cn(
                        "h-full rounded-full",
                        disciplineStatus.tradesToday >= disciplineStatus.maxTrades
                ...
                <div>
                  ...
                  <div className="h-2 bg-secondary rounded-full overflow-hidden">
                    <motion.div
                      initial={{ width: 0 }}
                      animate={{
                        width: `${(disciplineStatus.lossStreak / disciplineStatus.maxLossStreak) * 100}%`,
                      }}
                      className={cn(
                        "h-full rounded-full",
                        disciplineStatus.lossStreak >= disciplineStatus.maxLossStreak
